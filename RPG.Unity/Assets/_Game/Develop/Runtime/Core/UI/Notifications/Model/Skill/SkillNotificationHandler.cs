...
{
    public class SkillNotificationHandler : INotificationProvider
    {
        ...
        private readonly string _windowType = nameof(SkillInventoryWindow);
        ...
        public SkillNotificationHandler(ObjectPoolWithParent<NotificationView> pool) => 
            _pool = pool;
        ...
        public void Initialize()
        {
            ...
            if (_windowService.IsExist<SkillInventoryWindow>())
                HandleWindow().Forget();
            else
        ...
        {
            var window = await _windowService.GetAsync<SkillInventoryWindow>(false);
