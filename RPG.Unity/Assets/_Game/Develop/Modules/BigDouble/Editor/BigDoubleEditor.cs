...
namespace PleasantlyGames.Modules.BigDouble.Editor
{
    [CustomPropertyDrawer(typeof(PleasantlyGames.BigDouble.Runtime.BigDouble))]
    public class BigDoubleDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                var normalized = PleasantlyGames.BigDouble.Runtime.BigDouble.Normalize(mantissa, exponent);
