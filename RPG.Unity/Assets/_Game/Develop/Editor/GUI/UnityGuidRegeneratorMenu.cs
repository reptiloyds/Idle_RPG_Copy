...
namespace PleasantlyGames.IdleRPG.Editor.GUI {
    public class UnityGuidRegeneratorMenu {
        [MenuItem("Tools/Regenerate asset GUIDs \"Assets.ChangeGUID\"")]
        public static void RegenerateGuids() {
            if (EditorUtility.DisplayDialog("GUIDs regeneration",
                ...
                try {
                    ...
                    string path = Path.GetFullPath(".") + Path.DirectorySeparatorChar + "Assets/ChangeGUID";
